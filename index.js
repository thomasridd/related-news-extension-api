...
const getData = async url => {
    ...
    if(glitchedData) {
        ...
        return filterNewsData(newsApiData)
    }
...
const filterNewsData = (fullData) => {
    return fullData.articles.filter(item => {
        const allowed = qualityList.domains.filter((domain) => item.url.indexOf(domain) > -1)
